...
interface HtsIconProps {
  className?: string;
  fill?: string;
}

const HtsIcon: React.FunctionComponent<HtsIconProps> = props => (
  <svg x="0px" y="0px" viewBox="0 0 486.742 486.742" fill="inherit" {...props}>
    <g>
      <g>
        <g>
          <path
